...
GOLD = (255, 215, 0) # 스네이크 바디
SNOW = (255,250,250)
PINK = (255,192,203)
SPEED = 3
SNAKEBODY = [RED,JU,YELLOW,GREEN,BLUE,NAM,BORA]
...
def paint(message):
    ...
    SURFACE.fill((0, 0, 0))
    for food in FOODS:
        pygame.draw.ellipse(SURFACE, SNOW,
                            Rect(food[0]*30, food[1]*30, 30, 30))
    for body in SNAKE:
        pygame.draw.rect(SURFACE, SNAKEBODY[random.randint(0,len(SNAKEBODY)-1)],
...
def main():
    ...
    # speedText = sysfont.render("Speed: " + str(SPEED), True, YELLOW)
    # speedText_rect = speedText.get_rect()
    # speedText_rect.center =  (200,150)
